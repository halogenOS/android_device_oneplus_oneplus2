...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom user_debug=29 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 boot_cpus=0-7 androidboot.selinux=permissive androidboot.verifiedbootstate=green androidboot.veritymode=enforcing
